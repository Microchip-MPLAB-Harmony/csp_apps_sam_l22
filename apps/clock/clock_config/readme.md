...
- Connect an oscilloscope to monitor the PORT pin PA15 (Pin 13 of the EXT3 header)
...
| ---------- | ---------------- |--------- |
| [SAM L22 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/ATSAML22-XPRO-B) | PB15 (Pin 10 of the EXT2 header)  | LED0 |
|||
