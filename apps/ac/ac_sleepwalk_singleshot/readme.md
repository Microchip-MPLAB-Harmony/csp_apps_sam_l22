...
- Connect a voltage below VDD to pin 3 of the EXT1 connector
...
|------|----------|---------|
| [SAM L22 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/ATSAML22-XPRO-B) | pin 3 of the EXT1 connector | LED0 |
|||
